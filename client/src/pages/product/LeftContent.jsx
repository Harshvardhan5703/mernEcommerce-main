...
export const LeftContent = ({ data }) => {
  ...
  useEffect(() => {
    const isInWishlist = userWishlist.some(item => item.id === data._id);
  ...
  const addToFavorites = () => {
    ...
    const isAlreadyInWishlist = userWishlist.some(item => item.id === data._id);
  ...
  const removeFromFavorites = () => {
    const newWishlist = userWishlist.filter((item) => item.id !== data._id);
